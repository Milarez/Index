...
iris[, 'Species', drop= FALSE] #retorna a coluna espécies, indexada pelo nome, em formato coluna
...
iris$Sepal.Length >= 0 & iris$Petal.Width <= 0.2 #testa se, numa dada linha, os valores na sepal.lenght são menores ou iguais a 0 ou se os valores em sepal.width são iguais ou menores que 0.2

which(iris$Sepal.Length <= 5) #função which mostra a posição (as linhas) em que a condição é atendida
